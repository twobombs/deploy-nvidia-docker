...
RUN apt-get -y -f install ocl-icd-libopencl1 opencl-headers ocl-icd-opencl-dev beignet lm-sensors hddtemp python-pip clinfo  && apt-get clean all && apt -y autoremove

...
# add OCL dev & system frameworks
RUN apt-get -y -f install ocl-icd-libopencl1 opencl-headers ocl-icd-opencl-dev opencl-icd-* beignet lm-sensors hddtemp python3-pip clinfo freeglut3 && apt-get clean all && apt -y autoremove

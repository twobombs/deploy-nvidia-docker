...
RUN export DEBIAN_FRONTEND=noninteractive && apt-get install -y xvfb xfce4 xfce4-goodies ubuntu-desktop gnome-panel gnome-settings-daemon metacity nautilus gnome-terminal libsdl1.2-dev
